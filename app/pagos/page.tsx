...
export default function PagosGeneral() {
  ...
  const abrirPagos = (id: string) => {
    window.location.href = `/pacientes/${id}/pagos`;
  };
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
              ...
              <div>
                ...
                <p className="text-slate-500 mt-2">
                  Selecciona un paciente para consultar y gestionar sus pagos.
                </p>
              </div>

              <div className="bg-green-50 text-green-700 px-4 py-3 rounded-xl font-semibold">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                {pacientesFiltrados.map((paciente) => (
                  ...
                  <button
                    key={paciente.id}
                    type="button"
                    onClick={() => abrirPagos(paciente.id)}
