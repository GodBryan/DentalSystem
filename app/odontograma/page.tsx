...
export default function OdontogramaGeneral() {
  ...
  const pacientesFiltrados = pacientes.filter((paciente) => {
    const texto = `${paciente.nombres} ${paciente.apellidos} ${paciente.documento}`
      .toLowerCase();

    return texto.includes(busqueda.toLowerCase());
  });

  const abrirOdontograma = (id: string) => {
    window.location.href = `/pacientes/${id}/odontograma`;
  };
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
              ...
              <div>
                ...
                <p className="text-slate-500 mt-2">
                  Selecciona un paciente para consultar su odontograma.
                </p>
